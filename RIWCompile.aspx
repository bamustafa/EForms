<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RIWCompile.aspx.cs" Inherits="RIWCompile" EnableSessionState="True" Async="true"%>
...
<script type="text/javascript" src="JQSource/jquery-1.9.0-vsdoc.js"></script>
<script type="text/javascript" src="JQSource/jquery-1.9.0.js"></script>
<script type="text/javascript" src="JQSource/jquery.dim-background.min.js"></script>
...
.ChkBoxClass input {width:17px; height:17px;}
...
<form id="form1" runat="server">
    ...
    <section class="showcase">
        <div class="w3-container w3-center">
            <h1 class="w3-text-shadow w3-animate-opacity">E-Inspection Compilation Form</h1> <%--E-Inspection Review by Lead Action--%>
            <hr />
        </div>
    </section> 
    ...
    <section class="fillBody">
        <div class="w3-container w3-center"> 
            ...
            <table class="rounded-corners-First auto-style2" style="margin-top:20px;" align="center" cellpadding="0px" cellspacing="0px">                
                ...
                <tr>
                    <td class="ValueCSS" style="border-bottom:1px solid !important;border-right:1px solid !important;"><asp:Label ID="lblIRNo" runat="server" class="textcss" ></asp:Label></td>
                    <td class="ValueCSS" style="border-bottom:1px solid !important;"> <asp:Label ID="lblTrade" class="textcss" runat="server" ></asp:Label></td>                 
                </tr>
                <tr>                    
            ...
            <asp:GridView ID="grdWorkflowtasks" width="100%" runat="server" AutoGenerateColumns="False" OnRowDataBound="grdWorkflowtasks_RowDataBound" CellPadding="1" BorderWidth="0.5px" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical" BackColor="White">               
                <AlternatingRowStyle />
                    <Columns >       
                        <asp:TemplateField  Visible="true" ItemStyle-Width="2%">
                        <ItemTemplate>
                            <asp:CheckBox ID="CheckBoxWTask" CssClass="ChkBoxClass" runat="server" Visible="true" Checked="true" ></asp:CheckBox>                           
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Title" ItemStyle-Width="30%"  Visible="False" >
                        <ItemTemplate >
                            <asp:Label ID="lblTitle" runat="server" Text='<%#Eval("Title")%>' ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="AssignedTo"  ItemStyle-Width="17%" >
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Date" ItemStyle-Width="10%">
                        <ItemTemplate>
                            <asp:Label ID="lblStartDate" runat="server" Text='<%# Eval("Date","{0:dd/MM/yyyy}") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>                   
                    ...
                    <asp:TemplateField HeaderText="Code" ItemStyle-Width="10%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Comments" ItemStyle-Width="25%" >
                        <ItemTemplate>
                            <asp:Label ID="lblComments" runat="server" Text='<%# Eval("Comment") %>' ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Attachments" ItemStyle-Width="17%">
                        <ItemTemplate>                      
                            <asp:CheckBoxList id="Chkattachments" CssClass="ChkBoxClass" runat="server" ></asp:CheckBoxList>                 
                        </ItemTemplate>                       
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Preview Link" ItemStyle-Width="12%">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblattachments" ></asp:Label>
                            <%--<iframe ID="embedpdfViewer2" runat="server" style="width:200px; height:200px; border: none;"></iframe> --%>                         
                        </ItemTemplate>
                    </asp:TemplateField>

                </Columns>
                <RowStyle ForeColor="Black" Font-Size="12px" BorderColor="black" BorderStyle="Solid" BorderWidth="1px"/>                
                <HeaderStyle BackColor="#3CDBC0" Font-Bold="True" ForeColor="black" Font-Size="13px" BorderColor="black" BorderStyle="Solid" BorderWidth="0.5px"/>               
            </asp:GridView>  
            </div>                       

            <div class="w3-animate-opacity" style="text-align:left;width:100%;">   
                <asp:Label style="margin-top:15px;" ID="ItemsLbl" runat="server" CssClass="Paragraphs"><i  class="fa fa-cog fa-spin" aria-hidden="true"></i> <span style="color: #37c1aa;">Hint:</span><span style="color:red;"> Please uncheck the Open part tasks that you dont want to include to be able to close the E-Inspection.</span></asp:Label>               
            </div>
            <br />
            </div>           
